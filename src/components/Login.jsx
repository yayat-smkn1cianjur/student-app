        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-8 animate-in fade-in duration-500">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FaLock className="size-5 text-gray-400" />
                </div>
                <input
                ...
                >
                  {showPassword ? (
                    <FaEyeSlash className="size-5 text-gray-400 hover:text-gray-600" />
                  ) : (
                    <FaEye className="size-5 text-gray-400 hover:text-gray-600" />
                  )}
                </button>
              </div>
            </div>
